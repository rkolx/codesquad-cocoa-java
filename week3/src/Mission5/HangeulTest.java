...
class ClockTest {
    ...
    public void setHour() {
        ...
        for (int i = 0; i < temp.length; i = i + 2) {
            hangeul[temp[i]][temp[i + 1]]=PURPLE_BOLD_BRIGHT+hangeul[temp[i]][temp[i + 1]]+RESET;
        }
    ...
    public void setMinute() {
        ...
        if(minute>=10){
            ...
            for (int i = 0; i < temp1.length; i = i + 2) {
                hangeul[temp1[i]][temp1[i + 1]] = PURPLE_BOLD_BRIGHT+hangeul[temp1[i]][temp1[i + 1]]+RESET;
            }
            for (int j = 0; j < temp2.length; j = j + 2) {
                hangeul[temp2[j]][temp2[j + 1]]=PURPLE_BOLD_BRIGHT+hangeul[temp2[j]][temp2[j + 1]]+RESET;
            }
        }else if(minute!=0){
            temp1 = setDate.get(minute);
            for (int j = 0; j < temp1.length; j = j + 2) {
                hangeul[temp1[j]][temp1[j + 1]]=PURPLE_BOLD_BRIGHT+hangeul[temp1[j]][temp1[j + 1]]+RESET;
            }
        }
    ...
    public void print() {
        ...
        {
            for (int j = 0; j < hangeul[i].length; j++) {
                System.out.print(hangeul[i][j] + " ");
            }
            System.out.println();
        }
    }
